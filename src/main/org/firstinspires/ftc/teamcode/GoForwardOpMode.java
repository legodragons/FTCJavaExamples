...
// Objective:
// Use Gamepad's left stick only and Robot's front wheels only to move the Robot forward and backward

@TeleOp
//Name of the class must be same as filename
public class GoForwardOpMode extends OpMode {
  ...
  public void loop() {
    ...
    int yPower = (-1) * gamepad1.left_stick_y;
    
    // Now we assign this power to the front wheels
    lfMotor.setPower(yPower);
    rfMotor.setPower(yPower);
  }
